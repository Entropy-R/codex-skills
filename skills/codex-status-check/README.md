...
The skill reads local Codex metadata to determine installed versions. It does not publish local paths, account information, or usage data by itself. When sharing output publicly, review the version block and remove any local executable paths if present.
